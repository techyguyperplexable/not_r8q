 ...
 *       Fixup cpu cluster logic in recent big.LITTLE platforms
 *       Add prime cluster logic, some rewrites for more precise cpu load calculation
...
/*
 * Flag and NOT editable/tuneable
 */
...
static struct asmp_param_struct {
    ...
    .max_cpus_pr = 1, /* Max Prime cores online */ 
    .max_cpus_bc = 3, /* Max Big cores online */ 
    .max_cpus_lc = 4, /* Max Little cores online */ 
    /* Note: We should always have at least one cpu online
     * in little & big cluster, Prime core is fine to turn off, 
     * since technically speaking it isn't an actual cluster,
     * its just a core, DynamIQ//SD865 moment
     */
    .min_cpus_pr = 1, /* Minimum Prime cores online */ 
    .min_cpus_bc = 1, /* Minimum Big cores online */ 
    .min_cpus_lc = 1, /* Minimum Little cores online */ 
    .cpufreq_up_pr = 40,
    .cpufreq_up_bc = 40,
    .cpufreq_up_lc = 30,
    .cpufreq_down_pr = 20,
...
#ifdef define_one_global_ro
#undef define_one_global_ro
#endif
...
#ifdef define_one_global_rw
#undef define_one_global_rw
#endif
